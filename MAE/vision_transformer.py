...
class Attention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        print("q,k,v.shape:",q.shape,k.shape,v.shape)  #  torch.Size([1, 12, 256, 64])
        attn_before_softmax = (q @ k.transpose(-2, -1)) * self.scale
        print("attn_before_softmax.shape:",attn_before_softmax.shape)  # attn.shape: torch.Size([1, 12, 256, 256])
